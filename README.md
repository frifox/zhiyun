...
I have Zhiyun Crane Plus gimbal and A6500 camera, but info below may apply to other gimbal & camera combos. All code samples are in Go because that's all I know from programming languages. Most of the data was obtained by watching bluetooth traffic from Zniyun's ZY Play app using Apple's PacketLogger.
